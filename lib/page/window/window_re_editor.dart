...
class WindowReEditor extends WindowBaseMDI {
  Function refresh;
  Revenue re;

  WindowReEditor({ required this.re, required this.refresh }) { }

  @override
  _WindowReEditorState createState() => _WindowReEditorState();
}
class _WindowReEditorState extends State<WindowReEditor> {
  var dividHeight = 6.0;
  var heightSize = 36.0;
