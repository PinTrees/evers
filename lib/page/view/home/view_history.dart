...
class _ViewHistoryState extends State<ViewHistory> {
  ...
  var infoText = "에버스는 건강한 식품 개발을 주된 목적사업으로 하여 태어났어요.  에버스는 동결건조 경험을 바탕으로 CDI 방식의 동결건조 시스템 새로 구축하였고,  2018. 3. 27. 법인으로 출발하게 되었어요. 에버스는 그 동안 건강하고  행복한 식품, 스낵 개발 등을 위해 노력해 왔어요. 외주에 의한 동결건조 경험을 기초로 직접 건강한 식품, 스낵의 맛을 탐구하고 찾아내기 위해 노력하였어요."
      ...
      children: [
        ...
        Positioned(
          child: Column(
            ...
            children: [
              TextT.Lit(text: "우리의 가치", color: Colors.white, bold: true, size: 20),
              SizedBox(height: 6 * 4,),
              TextT.Lit(text: "건강과 맛의 향연, 신제품을 향한 끊임없는 도전", color: Colors.white, size: 28),
            ],
          ),
        )
      ],
