    ...
    var w = Container(
      ...
      child: Row(
        children: [
          ...
          ExcelT.LitGrid(text: StyleT.krwDouble(re.count), width: 80, center: true),
        ...
        Row(
            children: [
              ...
              ExcelT.LitInput(context, "$index::re.count", width: 80, index: index,
                setState: setState,
                onEdited: (i, data) { re.count = double.tryParse(data) ?? 0; },
                text: StyleT.krwDouble(re.count), value: re.count.toString(),
              ),
