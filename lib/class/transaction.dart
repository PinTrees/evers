      ...
      child: Container(
        ...
        child: Row(
            children: [
              ...
              ExcelT.LitGrid(text: id, width: 80, center: true),
              ExcelT.LitGrid(text: StyleT.dateFormatAtEpoch(transactionAt.toString()), width: 80, center: true),
              TextT.OnTap(
              ...
              ExcelT.Grid(textSize: 10, text: summary, expand: true, width: 250),
              ExcelT.LitGrid(text: StyleT.krwInt(amount), width: 80, center: true,
                  textColor: (type == 'RE') ? Colors.blue.withOpacity(0.7) : Colors.transparent),
              ExcelT.LitGrid(text: StyleT.krwInt(amount), width: 80, center: true,
                  textColor: (type == 'PU') ? Colors.red.withOpacity(0.7) : Colors.transparent),
              ExcelT.LitGrid(text: SystemT.getAccountName(account) ?? '-', width: 100, center: true),
              ExcelT.LitGrid(text: memo, width: 100, center: true, expand: true),
      ...
      child: Row(
          children: [
            ...
            ExcelT.LitInput(context, '$index::ts거래일자', width: 150, index: index,
              ...
              setState: setState,
              text: StyleT.dateInputFormatAtEpoch(transactionAt.toString()),
            ),
            ExcelT.LitGrid(text: (type != 'PU') ? '수입' : '지출', width: 100, center: true),
            SizedBox(
              height: 28, width: 28,
            ...
            ExcelT.LitInput(context, '$index::ts적요', width: 250, index: index,
              onEdited: (i, data) { summary = data; }, text: summary,
              setState: setState,
            ),
            ExcelT.LitGrid(text: (SystemT.accounts[account] != null) ? SystemT.accounts[account]!.name : 'NULL', width: 180, center: true),
            SizedBox(
              height: 28, width: 28,
              child: DropdownButtonHideUnderline(
                child: DropdownButton2(
            ...
            ExcelT.LitInput(context, '$index::ts금액', width: 120, index: index,
              onEdited: (i, data) {  amount = int.tryParse(data) ?? 0; },
              setState: setState,
              text: StyleT.krwInt(amount), value: amount.toString(),),
